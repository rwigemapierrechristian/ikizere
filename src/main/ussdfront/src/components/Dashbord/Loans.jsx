...
const Savings = () =>{
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('/ussd/allLoans');
  ...
  const handleUpdateSubmit = () => {
    axios
      .put('/ussd/updateLoans', modifiedData)
      .then((response) => {
  ...
  const handleDelete = async (phoneNumber) => {
    try {
      await axios.delete(`/ussd/loans/${phoneNumber}`);
        ...
        <div className="list-group list-group-flush" >
            ...
            modifiedData.phoneNumber === item.phoneNumber ? (
              <tr key={index}>
                ...
                <td>
                  <input  type="text"  value={modifiedData.status}  onChange={(e) => setModifiedData({...modifiedData, status: e.target.value,})}/>
                </td>
                ...
                <td className='data'>{item.status}</td>
            ...
            <form className="needs-validation" onSubmit={handleSubmit}>
              ...
              <div className="form-group was-validated mb-2">
                ...
                <div className="invalid-feedback">
                  Please Enter the number taking the loan
                </div>
              </div>
              <div className="form-group was-validated mb-2">
              ...
              <div className="form-group was-validated mb-2">
                ...
                />
                <div className="invalid-feedback">
                  Please Enter loan status as pending
                </div>
              </div>
          </div>
              <button
