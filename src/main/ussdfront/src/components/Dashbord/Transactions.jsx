...
const Savings = () =>{
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('/ussd/allTransactions');
  ...
  const handleUpdateSubmit = () => {
    axios
      .put('/ussd/updateTransactions', modifiedData)
      .then((response) => {
  ...
  const handleDelete = async (number) => {
    try {
      await axios.delete(`/ussd/transactions/${number}`);
    ...
    const handleSubmit = (event) => {
        ...
        axios
          .post('/ussd/postTransactions', inputData)
          .then((res) => {
        ...
        <div className="list-group list-group-flush" >
            ...
            modifiedData.number === item.number ? (
              <tr key={index}>
                ...
                <td>
                  <input type="text" value={modifiedData.amount} onChange={(e) => setModifiedData({  ...modifiedData, amounr: e.target.value, }) } />
                </td>
                <td>
                  <input  type="text"  value={modifiedData.transactionDateTime}  onChange={(e) => setModifiedData({...modifiedData, transactionDateTime: e.target.value,})}/>
                </td>
                <td>
                  <input  type="text"  value={modifiedData.description}  onChange={(e) => setModifiedData({...modifiedData, description: e.target.value,})}/>
                </td>
                ...
                <td className='data'>{item.transactionDateTime}</td>
            ...
            <form className="needs-validation" onSubmit={handleSubmit}>
              ...
              <div className="form-group was-validated mb-2">
                ...
                <input
                  ...
                  className="form-control"
                  onChange={(e) =>
                    setInputData({ ...inputData, transactionDateTime: e.target.value })
                  }
                  required
                />
                <div className="invalid-feedback">
